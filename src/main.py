...
from models.FBUSSN import (Basic_Unet, 
                           Shape_Unet, 
                           )
...
def runTraining(args):
    ...
    if args.model == 'Basic_Unet':
        ...
        train_set_SP = medicalDataLoader.MedicalImageDataset('train',
                                                      root_dir_SP,
                                                      transform=transform,
                                                      mask_transform=mask_transform,
                                                      augment=True,
        ...
        val_set_SP = medicalDataLoader.MedicalImageDataset('val',
                                                        root_dir_SP,
                                                        transform=transform,
                                                        mask_transform=mask_transform,
                                                        equalize=False,
    ...
    for i in range(args.start_epoch, args.epochs):
        ...
        for j, data in enumerate(train_loader):
            ...
            region_ = predToSegmentation(region)
