...
if __name__ == '__main__':
 ###  Testing  ###
    ...
    parser.add_argument('--modelName', default='Week_Improved_AttentionUnet', type=str)
    parser.add_argument('--testModelName', default='Week_Improved_AttentionUnet', type=str)
    parser.add_argument('--batchSize', default=1, type=int)
    # Save Root #
    base_dir = '/home/wangqifeng/FBUSTS-3.0/Results/CV/'
    Model ='Week_Improved_AttentionUnet'
    TestModel ='Best_Week_Improved_AttentionUnet_(Epoch-99).pth'
    SaveType = 'Pred-region' # GT&Pred, GT, GT-edge, GT-region, Pred, Pred-edge, Pred-region
    
 
    parser.add_argument('--org_dataset_dir', default='/home/wangqifeng/FBUSTS-3.0/DataSet/CV/', type=str)
    parser.add_argument('--test_dataset_dir', default='/home/wangqifeng/FBUSTS-3.0/DataSet/CV-128/', type=str)
    ...
    parser.add_argument('--image_save_dir', default=os.path.join(base_dir, Model, 'Image', SaveType), type=str)
    parser.add_argument('--statistics_save_dir', default=os.path.join(base_dir, Model, 'Statistics'), type=str)
    parser.add_argument('--week_path', default='/home/wangqifeng/FBUSTS-3.0/DataSet/CV-128/CV_name_with_week.txt', type=str)
    
    parser.add_argument('--save_type', default=SaveType, type=str)
 ...
 ###  Runing  ###
    ...
    #                                                transform=transform)
    test_set = medicalDataLoader.MedicalImageDataset_week('val',
                                                    args.test_dataset_dir,
                                                    args.week_path,
                                                    transform=transform,
                                                    equalize=False) 
    ...
    elif args.testModelName == 'Week_Improved_ZAM_WAM_Unet':
        net = Week_Improved_ZAM_WAM_Unet()
    elif args.testModelName == 'Week_Improved_AttentionUnet':
